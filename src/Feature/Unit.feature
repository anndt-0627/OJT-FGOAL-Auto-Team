Feature: Unit List
  ...
  Scenario Outline: All item on Unit List page are display correctly
  ...
  Scenario Outline: Unit table show corresponding number of entries chosen by Show entries dropdown
    ...
    When User choose any "<number of entries>" in Show entries dropdown
